...
f.create_histograms(populations_collection, 'Study 3: distribution of X1')

# Now we create plots that visualize MSE of each model for a timespan of t years
f.create_plot_MSE(population_scores_mlr, population_scores_rfr, population_scores_gbr, 'Study 3: MSE overtime')
