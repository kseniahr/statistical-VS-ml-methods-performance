...
class Study_4():
    ...
    def run_simulation(self):
        ...
        eval_obj.create_histograms(self.defaults, populations_collection, 'Study 4: distribution of X1', self.dimensionality, self.complexity, self.var_type)
        ...
        eval_obj.create_plot_MSE(self.defaults, population_scores_mlr, population_scores_rfr, \
         population_scores_gbr, 'Study 4 concept drift: MSE overtime', self.dimensionality, self.complexity, self.var_type)
